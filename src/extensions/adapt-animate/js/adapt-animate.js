...
class Animate extends Backbone.Controller {
  ...
  setupAnimate() {
    ...
    // Article
    if (Adapt.course.get('_animate')._article && Adapt.course.get('_animate')._article._isEnabled) {
    ...
    // Block
    if (Adapt.course.get('_animate')._block && Adapt.course.get('_animate')._block._isEnabled) {
      Adapt.animate.animateBlockEnabled = Adapt.course.get('_animate')._block._isEnabled;
    } else {
      Adapt.animate.animateBlockEnabled = false;
    }
    // Component
    if (Adapt.course.get('_animate')._component && Adapt.course.get('_animate')._component._isEnabled) {
