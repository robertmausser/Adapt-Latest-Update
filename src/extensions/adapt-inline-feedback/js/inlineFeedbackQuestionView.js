define([
  ...
  const InlineFeedbackComponentView = {
    ...
    populateFeedback: function() {
      ...
      let feedbackContent = this.model.get('feedbackMessage')
      $feedbackMessage.html('<div class=\'feedbackTitle\'>' + this.model.get('_feedback').title + '</div>' + feedbackContent);
   ...
   showMarking() {
    ...
    checkQuestionCompletion: function() {
      ...
      this.$('.js-btn-marking').removeClass('u-display-none').addClass(isCorrect ? 'is-correct' : 'is-incorrect');
